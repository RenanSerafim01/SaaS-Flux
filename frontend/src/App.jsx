                            ...
                            <div className="flex items-center gap-3 relative z-10">
                                <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#0b0f19] to-[#1a2133] rounded-xl border border-gray-800 shadow-lg shrink-0 overflow-hidden">
                                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                            <linearGradient id="fluxGradLightModalLeft" x1="0%" y1="0%" x2="100%" y2="100%">
                                                <stop offset="0%" stopColor="#0ea5e9" />
                                                <stop offset="100%" stopColor="#6366f1" />
                                            </linearGradient>
                                            <linearGradient id="coinGradLightModalLeft" x1="0%" y1="0%" x2="100%" y2="100%">
                                                <stop offset="0%" stopColor="#0ea5e9" stopOpacity="0.15" />
                                                <stop offset="100%" stopColor="#6366f1" stopOpacity="0.15" />
                                            </linearGradient>
                                        </defs>
                                        <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" stroke="url(#fluxGradLightModalLeft)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        <circle cx="12" cy="12" r="4.5" fill="url(#coinGradLightModalLeft)" stroke="url(#fluxGradLightModalLeft)" strokeWidth="1.0" />
                                        <path d="M12 9v6M13.5 10.5c0-.8-.6-1.5-1.5-1.5s-1.5.7-1.5 1.5c0 1.7 3 1.3 3 3 0 .8-.6 1.5-1.5 1.5s-1.5-.7-1.5-1.5" stroke="url(#fluxGradLightModalLeft)" strokeWidth="1.0" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </div>
                        ...
                        <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center relative">
                            ...
                            <div className="mb-8 flex items-center gap-3">
                                ...
                                <div className="md:hidden flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#0b0f19] to-[#1a2133] rounded-xl border border-gray-800 shadow-lg shrink-0 overflow-hidden">
                                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <defs>
                                            <linearGradient id="fluxGradLightModalRight" x1="0%" y1="0%" x2="100%" y2="100%">
                                                <stop offset="0%" stopColor="#0ea5e9" />
                                                <stop offset="100%" stopColor="#6366f1" />
                                            </linearGradient>
                                            <linearGradient id="coinGradLightModalRight" x1="0%" y1="0%" x2="100%" y2="100%">
                                                <stop offset="0%" stopColor="#0ea5e9" stopOpacity="0.15" />
                                                <stop offset="100%" stopColor="#6366f1" stopOpacity="0.15" />
                                            </linearGradient>
                                        </defs>
                                        <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" stroke="url(#fluxGradLightModalRight)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        <circle cx="12" cy="12" r="4.5" fill="url(#coinGradLightModalRight)" stroke="url(#fluxGradLightModalRight)" strokeWidth="1.0" />
                                        <path d="M12 9v6M13.5 10.5c0-.8-.6-1.5-1.5-1.5s-1.5.7-1.5 1.5c0 1.7 3 1.3 3 3 0 .8-.6 1.5-1.5 1.5s-1.5-.7-1.5-1.5" stroke="url(#fluxGradLightModalRight)" strokeWidth="1.0" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                </div>
                                <div>
                            ...
                            <form onSubmit={isRecuperarMode ? handleRecuperarSenha : (isLoginMode ? handleLogin : handleCadastro)} className="space-y-4 md:space-y-5">
                                ...
                                {!isLoginMode && !isRecuperarMode && (
                                    <div>
                                        <label className="block mb-1.5 text-[9px] md:text-[10px] font-black text-gray-500 tracking-widest uppercase">Nome Completo</label>
                                ...
                                <div>
                                    <label className="block mb-1.5 text-[9px] md:text-[10px] font-black text-gray-500 tracking-widest uppercase">Login (E-mail)</label>
                                ...
                                {!isRecuperarMode && (
                                    <div>
                                        <label className="block mb-1.5 text-[9px] md:text-[10px] font-black text-gray-500 tracking-widest uppercase">Senha</label>
                                        <div className="relative">
                                            <input
                                                type={mostrarSenha ? "text" : "password"}
                                                value={senha}
                                                onChange={(e) => setSenha(e.target.value)}
                                                className="w-full pl-4 md:pl-5 pr-12 py-3 md:py-3.5 bg-[#0b0f19] text-white font-bold text-sm border border-gray-800 rounded-xl focus:ring-2 focus:ring-sky-500 focus:outline-none transition-all placeholder:text-gray-700"
                                                placeholder="••••••••••"
                                                required
                                            />
                                ...
                                {!isRecuperarMode && !isLoginMode && (
                                    <div>
                                        <label className="block mb-1.5 text-[9px] md:text-[10px] font-black text-gray-500 tracking-widest uppercase">Confirme a Senha</label>
                                        <div className="relative">
                                            <input
                                ...
                                <div className="pt-2">
                                    ...
                                    >
                                        {enviando
                                            ? 'Aguarde...'
                                            : (isRecuperarMode ? 'Enviar Link' : (isLoginMode ? 'Acessar Conta' : 'Cadastrar Conta'))
                                        }
                                    </button>
                                </div>
                            </form>
                            ...
                            <div className="mt-8 text-center text-[10px] md:text-xs font-bold tracking-wider uppercase">
                                {isRecuperarMode ? (
                                    ...
                                    <span className="text-gray-500">
                                        Não tem conta? <span onClick={() => { setIsLoginMode(false); setMensagem({ texto: '', tipo: '' }); setNome(''); setSenha(''); setConfirmaSenha(''); }} className="text-sky-500 hover:text-sky-400 cursor-pointer transition ml-1">Criar conta</span>
                                    </span>
                                ) : (
                                    <span className="text-gray-500">
                                        Já tem uma conta? <span onClick={() => { setIsLoginMode(true); setMensagem({ texto: '', tipo: '' }); setNome(''); setSenha(''); setConfirmaSenha(''); }} className="text-sky-500 hover:text-sky-400 cursor-pointer transition ml-1">Faça Login</span>
                                    </span>
                                )}
                            </div>
