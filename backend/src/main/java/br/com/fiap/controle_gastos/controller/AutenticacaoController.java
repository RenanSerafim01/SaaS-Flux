...
public class AutenticacaoController {
    ...
    public ResponseEntity<?> efetuarLogin(@RequestBody @Valid DadosAutenticacao dados) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Falha na autenticação: Credenciais inválidas ou erro interno.");
        }
    }
    ...
    public ResponseEntity<?> cadastrar(@RequestBody @Valid DadosCadastroUsuario dados) {
        ...
        var novoUsuario = new Usuario(dados.nome(), dados.login(), senhaCriptografada);
